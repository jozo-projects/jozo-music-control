...
const GiftModal: React.FC = () => {
  ...
  useEffect(() => {
    if (isSuccess && claimResult) {
      setShowResult(true);
      markAsClaimed(claimResult.gift);
    }
          ...
          <div className="flex flex-col items-center justify-center py-8 relative">      
            {(claimResult?.gift || claimedGift) && (
              <div className="relative z-10 flex flex-col items-center">
                ...
                {(claimResult?.gift || claimedGift)?.image && (
                ...
                {(claimResult?.gift || claimedGift)?.type === "snacks_drinks" &&
                  ...
                  (claimResult?.gift || claimedGift)!.items!.length > 0 && (
                    <div className="w-full mb-4">
                      <div className="space-y-2">
                        {(claimResult?.gift || claimedGift)!.items!.map((item, index) => (
                          <div
                            key={index}
